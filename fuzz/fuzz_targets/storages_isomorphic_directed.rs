...
use gryf::{
    core::{error::AddEdgeErrorKind, id::DefaultId, marker::Directed},
    infra::{
...
fuzz_target!(|ops: MutOpsSeq<i8, i8>| {
    let mut adj_list = AdjList::<_, _, Directed, DefaultId>::new();
    let mut adj_list_multi = AdjList::<_, _, Directed, DefaultId>::new();

    let mut adj_matrix = AdjMatrix::<_, _, Directed, DefaultId>::new();

    let mut edge_list = EdgeList::<_, _, Directed, DefaultId>::new();
    let mut edge_list_multi = EdgeList::<_, _, Directed, DefaultId>::new();
